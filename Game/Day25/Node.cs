...
public class Node : MonoBehaviour
{
    ...
    public GameObject lightningEffect; // ⚡ Assign this in Inspector with your lightning prefab
    ...
    public void UpgradeToSilver()
    {
        ...
        {
            GameObject lightning = Instantiate(lightningEffect, GetBuildPosition(), Quaternion.identity);
            Destroy(lightning, 4f); // Clean up
        }
